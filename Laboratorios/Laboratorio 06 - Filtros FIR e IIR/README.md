# LABORATORIO 6: Filtrado de Señales

## **Tabla de contenidos:**
<div style="border: 2px solid gray; padding: 20px;border-radius: 15px; width: 40%; height: 180px;">

1. [**Ejercicio de Laboratorio para ECG**](#1-introducción)  
2. [**Ejercicio de Laboratorio para EMG**](#2-proposito-de-la-práctica)
3. [**Ejercicio de Laboratorio para EEG**](#3-materiales-y-metodos)

</div>
<br>

## **1) Ejercicio de Laboratorio para ECG** 
...
## **2) Ejercicio de Laboratorio para EMG** 

<br>
</p>
<div align="center">
  <img src="https://github.com/user-attachments/assets/edd33381-34c9-46a1-9ab8-8e83d3161701" width="450"><p>
    
  **Figura 2: Comparación de las señales crudas y filtradas del EMG**
  </p>
</div>
<br>


## **3) Ejercicio de Laboratorio para EEG** 
Se utilizaron 3 señales EEG obtenidas con BITalino en distintos estados: Ojos abiertos, realizando tarea cognitiva y realizando parpadeos
- **Filtro IIR:** Se utilizó un filtro Butterworth pasa banda de 0.5–30 Hz.
- **Filtro FIR:** Se diseñó un filtro FIR usando ventana Hann centrado en 12 Hz (banda alfa).
